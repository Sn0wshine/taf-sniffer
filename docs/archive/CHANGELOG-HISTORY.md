...
- Première base open source documentée.
- Licence MIT, guide de contribution, politique de sécurité et CI build/tests.
- README orienté utilisateurs et contributeurs.
